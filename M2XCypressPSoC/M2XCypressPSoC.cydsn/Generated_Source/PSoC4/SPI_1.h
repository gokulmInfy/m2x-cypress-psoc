...
#define SPI_1_SCB_MODE_UNCONFIG_RUNTM_CFG  (SPI_1_SCB_MODE_UNCONFIG  == SPI_1_scbMode)
...
#if(SPI_1_SCB_IRQ_INTERNAL)
    #define SPI_1_EnableInt()    SPI_1_SCB_IRQ_Enable()
    #define SPI_1_DisableInt()   SPI_1_SCB_IRQ_Disable()
#endif /* (SPI_1_SCB_IRQ_INTERNAL) */
...
#define SPI_1_CTRL_EC_AM_MODE        ((uint32) ((uint32) 0x01u << SPI_1_CTRL_EC_AM_MODE_POS))
#define SPI_1_CTRL_EC_OP_MODE        ((uint32) ((uint32) 0x01u << SPI_1_CTRL_EC_OP_MODE_POS))
#define SPI_1_CTRL_EZBUF_MODE        ((uint32) ((uint32) 0x01u << SPI_1_CTRL_EZBUF_MODE_POS))
#define SPI_1_CTRL_ADDR_ACCEPT       ((uint32) ((uint32) 0x01u << SPI_1_CTRL_ADDR_ACCEPT_POS))
#define SPI_1_CTRL_BLOCK             ((uint32) ((uint32) 0x01u << SPI_1_CTRL_BLOCK_POS))
#define SPI_1_CTRL_MODE_MASK         ((uint32) ((uint32) 0x03u << SPI_1_CTRL_MODE_POS))
#define SPI_1_CTRL_MODE_I2C          ((uint32)  0x00u)
#define SPI_1_CTRL_MODE_SPI          ((uint32) ((uint32) 0x01u << SPI_1_CTRL_MODE_POS))
#define SPI_1_CTRL_MODE_UART         ((uint32) ((uint32) 0x02u << SPI_1_CTRL_MODE_POS))
#define SPI_1_CTRL_ENABLED           ((uint32) ((uint32) 0x01u << SPI_1_CTRL_ENABLED_POS))
...
#define SPI_1_SPI_CTRL_SELECT_PRECEDE        ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_SPI_CTRL_SELECT_PRECEDE_POS))
#define SPI_1_SPI_CTRL_SCLK_MODE_MASK        ((uint32) ((uint32) 0x03u << \
                                                                    SPI_1_SPI_CTRL_CPHA_POS))
#define SPI_1_SPI_CTRL_CPHA                  ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_SPI_CTRL_CPHA_POS))
#define SPI_1_SPI_CTRL_CPOL                  ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_SPI_CTRL_CPOL_POS))
#define SPI_1_SPI_CTRL_LATE_MISO_SAMPLE      ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_SPI_CTRL_LATE_MISO_SAMPLE_POS))
#define SPI_1_SPI_CTRL_LOOPBACK              ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_SPI_CTRL_LOOPBACK_POS))
#define SPI_1_SPI_CTRL_MODE_MASK             ((uint32) ((uint32) 0x03u << \
                                                                    SPI_1_SPI_CTRL_MODE_POS))
#define SPI_1_SPI_CTRL_MODE_MOTOROLA         ((uint32) 0x00u)
#define SPI_1_SPI_CTRL_MODE_TI               ((uint32) ((uint32) 0x01u << SPI_1_CTRL_MODE_POS))
#define SPI_1_SPI_CTRL_MODE_NS               ((uint32) ((uint32) 0x02u << SPI_1_CTRL_MODE_POS))
#define SPI_1_SPI_CTRL_SLAVE_SELECT_MASK     ((uint32) ((uint32) 0x03u << \
                                                                    SPI_1_SPI_CTRL_SLAVE_SELECT_POS))
#define SPI_1_SPI_CTRL_SLAVE_SELECT0         ((uint32) 0x00u)
#define SPI_1_SPI_CTRL_SLAVE_SELECT1         ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_SPI_CTRL_SLAVE_SELECT_POS))
#define SPI_1_SPI_CTRL_SLAVE_SELECT2         ((uint32) ((uint32) 0x02u << \
                                                                    SPI_1_SPI_CTRL_SLAVE_SELECT_POS))
#define SPI_1_SPI_CTRL_SLAVE_SELECT3         ((uint32) ((uint32) 0x03u << \
                                                                    SPI_1_SPI_CTRL_SLAVE_SELECT_POS))
#define SPI_1_SPI_CTRL_MASTER                ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_SPI_CTRL_MASTER_MODE_POS))
...
#define SPI_1_SPI_STATUS_EZBUF_ADDR_MASK    ((uint32) ((uint32) 0xFFu << \
                                                                    SPI_1_I2C_STATUS_EZBUF_ADDR_POS))


/* SPI_1_UART_CTRL */
#define SPI_1_UART_CTRL_LOOPBACK_POS         (16u) /* [16] Loopback     */
#define SPI_1_UART_CTRL_MODE_POS             (24u) /* [24] UART subMode */
#define SPI_1_UART_CTRL_LOOPBACK             ((uint32) ((uint32) 0x01u << \
                                                                        SPI_1_UART_CTRL_LOOPBACK_POS))
#define SPI_1_UART_CTRL_MODE_UART_STD        ((uint32) 0x00u)
#define SPI_1_UART_CTRL_MODE_UART_SMARTCARD  ((uint32) ((uint32) 0x01u << \
                                                                        SPI_1_UART_CTRL_MODE_POS))
#define SPI_1_UART_CTRL_MODE_UART_IRDA       ((uint32) ((uint32) 0x02u << \
                                                                        SPI_1_UART_CTRL_MODE_POS))
#define SPI_1_UART_CTRL_MODE_MASK            ((uint32) ((uint32) 0x03u << \
                                                                        SPI_1_UART_CTRL_MODE_POS))
...
#define SPI_1_UART_TX_CTRL_PARITY                ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_UART_TX_CTRL_PARITY_POS))
#define SPI_1_UART_TX_CTRL_PARITY_ENABLED        ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_UART_TX_CTRL_PARITY_ENABLED_POS))
#define SPI_1_UART_TX_CTRL_RETRY_ON_NACK         ((uint32) ((uint32) 0x01u << \
...
#define SPI_1_UART_RX_CTRL_PARITY                    ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_UART_RX_CTRL_PARITY_POS))
#define SPI_1_UART_RX_CTRL_PARITY_ENABLED            ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_UART_RX_CTRL_PARITY_ENABLED_POS))
#define SPI_1_UART_RX_CTRL_POLARITY                  ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_UART_RX_CTRL_POLARITY_POS))
#define SPI_1_UART_RX_CTRL_DROP_ON_PARITY_ERR        ((uint32) ((uint32) 0x01u << \
                                                                SPI_1_UART_RX_CTRL_DROP_ON_PARITY_ERR_POS))
#define SPI_1_UART_RX_CTRL_DROP_ON_FRAME_ERR         ((uint32) ((uint32) 0x01u << \
                                                                SPI_1_UART_RX_CTRL_DROP_ON_FRAME_ERR_POS))
#define SPI_1_UART_RX_CTRL_MP_MODE                   ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_UART_RX_CTRL_MP_MODE_POS))
#define SPI_1_UART_RX_CTRL_LIN_MODE                  ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_UART_RX_CTRL_LIN_MODE_POS))
#define SPI_1_UART_RX_CTRL_SKIP_START                ((uint32) ((uint32) 0x01u << \
                                                                  SPI_1_UART_RX_CTRL_SKIP_START_POS))
#define SPI_1_UART_RX_CTRL_BREAK_WIDTH_MASK          ((uint32) ((uint32) 0x0Fu << \
...
#define SPI_1_I2C_CTRL_LOW_PHASE_OVS_MASK   ((uint32) ((uint32) 0x0Fu << \
                                                                SPI_1_I2C_CTRL_LOW_PHASE_OVS_POS))
#define SPI_1_I2C_CTRL_M_READY_DATA_ACK      ((uint32) ((uint32) 0x01u << \
                                                                SPI_1_I2C_CTRL_M_READY_DATA_ACK_POS))
#define SPI_1_I2C_CTRL_M_NOT_READY_DATA_NACK ((uint32) ((uint32) 0x01u << \
                                                                SPI_1_I2C_CTRL_M_NOT_READY_DATA_NACK_POS))
#define SPI_1_I2C_CTRL_S_GENERAL_IGNORE      ((uint32) ((uint32) 0x01u << \
                                                                SPI_1_I2C_CTRL_S_GENERAL_IGNORE_POS))
#define SPI_1_I2C_CTRL_S_READY_ADDR_ACK      ((uint32) ((uint32) 0x01u << \
                                                                SPI_1_I2C_CTRL_S_READY_ADDR_ACK_POS))
#define SPI_1_I2C_CTRL_S_READY_DATA_ACK      ((uint32) ((uint32) 0x01u << \
                                                                SPI_1_I2C_CTRL_S_READY_DATA_ACK_POS))
#define SPI_1_I2C_CTRL_S_NOT_READY_ADDR_NACK ((uint32) ((uint32) 0x01u << \
                                                                SPI_1_I2C_CTRL_S_NOT_READY_ADDR_NACK_POS))
#define SPI_1_I2C_CTRL_S_NOT_READY_DATA_NACK ((uint32) ((uint32) 0x01u << \
                                                                SPI_1_I2C_CTRL_S_NOT_READY_DATA_NACK_POS))
#define SPI_1_I2C_CTRL_LOOPBACK              ((uint32) ((uint32) 0x01u << \
                                                                SPI_1_I2C_CTRL_LOOPBACK_POS))
#define SPI_1_I2C_CTRL_SLAVE_MODE            ((uint32) ((uint32) 0x01u << \
                                                                SPI_1_I2C_CTRL_SLAVE_MODE_POS))
#define SPI_1_I2C_CTRL_MASTER_MODE           ((uint32) ((uint32) 0x01u << \
                                                                SPI_1_I2C_CTRL_MASTER_MODE_POS))
#define SPI_1_I2C_CTRL_SLAVE_MASTER_MODE_MASK    ((uint32) ((uint32) 0x03u << \
                                                                SPI_1_I2C_CTRL_SLAVE_MODE_POS))
...
#define SPI_1_I2C_STATUS_S_READ          ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_I2C_STATUS_S_READ_POS))
#define SPI_1_I2C_STATUS_M_READ          ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_I2C_STATUS_M_READ_POS))
#define SPI_1_I2C_STATUS_EZBUF_ADDR_MASK ((uint32) ((uint32) 0xFFu << \
                                                                    SPI_1_I2C_STATUS_EZBUF_ADDR_POS))
...
#define SPI_1_I2C_MASTER_CMD_M_START_ON_IDLE ((uint32) ((uint32) 0x01u << \
                                                                   SPI_1_I2C_MASTER_CMD_M_START_ON_IDLE_POS))
#define SPI_1_I2C_MASTER_CMD_M_ACK           ((uint32) ((uint32) 0x01u << \
                                                                   SPI_1_I2C_MASTER_CMD_M_ACK_POS))
#define SPI_1_I2C_MASTER_CMD_M_NACK          ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_I2C_MASTER_CMD_M_NACK_POS))
#define SPI_1_I2C_MASTER_CMD_M_STOP          ((uint32) ((uint32) 0x01u << \
...
#define SPI_1_I2C_SLAVE_CMD_S_NACK       ((uint32) ((uint32) 0x01u << \
                                                                SPI_1_I2C_SLAVE_CMD_S_NACK_POS))
...
#define SPI_1_I2C_CFG_SDA_FILT_TRIM_MASK         ((uint32) ((uint32) 0x03u << \
                                                                SPI_1_I2C_CFG_SDA_FILT_TRIM_POS))
#define SPI_1_I2C_CFG_SCL_FILT_HYS_MASK          ((uint32) ((uint32) 0x03u << \
                                                                SPI_1_I2C_CFG_SCL_FILT_HYS_POS))
#define SPI_1_I2C_CFG_SCL_FILT_TRIM_MASK         ((uint32) ((uint32) 0x03u << \
                                                                SPI_1_I2C_CFG_SCL_FILT_TRIM_POS))
#define SPI_1_I2C_CFG_SDA_FILT_OUT_HYS_MASK      ((uint32) ((uint32) 0x03u << \
                                                                SPI_1_I2C_CFG_SDA_FILT_OUT_HYS_POS))
#define SPI_1_I2C_CFG_SDA_FILT_OUT_TRIM_MASK     ((uint32) ((uint32) 0x03u << \
                                                                SPI_1_I2C_CFG_SDA_FILT_OUT_TRIM_POS))
#define SPI_1_I2C_CFG_SDA_FILT_HS                ((uint32) ((uint32) 0x01u << \
                                                                SPI_1_I2C_CFG_SDA_FILT_HS_POS))
#define SPI_1_I2C_CFG_SDA_FILT_ENABLED           ((uint32) ((uint32) 0x01u << \
                                                                SPI_1_I2C_CFG_SDA_FILT_ENABLED_POS))
#define SPI_1_I2C_CFG_SCL_FILT_HS                ((uint32) ((uint32) 0x01u << \
                                                                SPI_1_I2C_CFG_SCL_FILT_HS_POS))
#define SPI_1_I2C_CFG_SCL_FILT_ENABLED           ((uint32) ((uint32) 0x01u << \
                                                                SPI_1_I2C_CFG_SCL_FILT_ENABLED_POS))
#define SPI_1_I2C_CFG_SDA_FILT_OUT_HS            ((uint32) ((uint32) 0x01u << \
                                                                SPI_1_I2C_CFG_SDA_FILT_OUT_HS_POS))
#define SPI_1_I2C_CFG_SDA_FILT_OUT_ENABLED       ((uint32) ((uint32) 0x01u << \
...
#define SPI_1_TX_CTRL_MSB_FIRST          ((uint32) ((uint32) 0x01u << \
                                                                        SPI_1_TX_CTRL_MSB_FIRST_POS))
#define SPI_1_TX_CTRL_LSB_FIRST          ((uint32) 0x00u)
#define SPI_1_TX_CTRL_ENABLED            ((uint32) ((uint32) 0x01u << SPI_1_TX_CTRL_ENABLED_POS))
...
#define SPI_1_TX_FIFO_CTRL_CLEAR                 ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_TX_FIFO_CTRL_CLEAR_POS))
#define SPI_1_TX_FIFO_CTRL_FREEZE                ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_TX_FIFO_CTRL_FREEZE_POS))
...
#define SPI_1_TX_FIFO_SR_VALID           ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_TX_FIFO_SR_VALID_POS))
#define SPI_1_TX_FIFO_STATUS_RD_PTR_MASK ((uint32) ((uint32) 0x07u << \
                                                                    SPI_1_TX_FIFO_STATUS_RD_PTR_POS))
#define SPI_1_TX_FIFO_STATUS_WR_PTR_MASK ((uint32) ((uint32) 0x07u << \
...
#define SPI_1_RX_CTRL_MSB_FIRST          ((uint32) ((uint32) 0x01u << \
                                                                        SPI_1_RX_CTRL_MSB_FIRST_POS))
#define SPI_1_RX_CTRL_LSB_FIRST          ((uint32) 0x00u)
#define SPI_1_RX_CTRL_MEDIAN             ((uint32) ((uint32) 0x01u << SPI_1_RX_CTRL_MEDIAN_POS))
#define SPI_1_RX_CTRL_ENABLED            ((uint32) ((uint32) 0x01u << SPI_1_RX_CTRL_ENABLED_POS))
...
#define SPI_1_RX_FIFO_CTRL_CLEAR                 ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_RX_FIFO_CTRL_CLEAR_POS))
#define SPI_1_RX_FIFO_CTRL_FREEZE                ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_RX_FIFO_CTRL_FREEZE_POS))
...
#define SPI_1_RX_FIFO_SR_VALID           ((uint32) ((uint32) 0x01u << \
                                                                  SPI_1_RX_FIFO_SR_VALID_POS))
#define SPI_1_RX_FIFO_STATUS_RD_PTR_MASK ((uint32) ((uint32) 0x07u << \
                                                                  SPI_1_RX_FIFO_STATUS_RD_PTR_POS))
#define SPI_1_RX_FIFO_STATUS_WR_PTR_MASK ((uint32) ((uint32) 0x07u << \
...
#define SPI_1_RX_MATCH_MASK_MASK    ((uint32) ((uint32) 0xFFu << SPI_1_RX_MATCH_MASK_POS))
...
#define SPI_1_INTR_CAUSE_SLAVE       ((uint32) ((uint32) 0x01u << SPI_1_INTR_CAUSE_SLAVE_POS))
#define SPI_1_INTR_CAUSE_TX          ((uint32) ((uint32) 0x01u << SPI_1_INTR_CAUSE_TX_POS))
#define SPI_1_INTR_CAUSE_RX          ((uint32) ((uint32) 0x01u << SPI_1_INTR_CAUSE_RX_POS))
#define SPI_1_INTR_CAUSE_I2C_EC      ((uint32) ((uint32) 0x01u << SPI_1_INTR_CAUSE_I2C_EC_POS))
#define SPI_1_INTR_CAUSE_SPI_EC      ((uint32) ((uint32) 0x01u << SPI_1_INTR_CAUSE_SPI_EC_POS))
...
#define SPI_1_INTR_SPI_EC_EZBUF_STOP           ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_INTR_SPI_EC_EZBUF_STOP_POS))
#define SPI_1_INTR_SPI_EC_EZBUF_WRITE_STOP     ((uint32) ((uint32) 0x01u << \
...
#define SPI_1_INTR_I2C_EC_EZBUF_STOP           ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_INTR_I2C_EC_EZBUF_STOP_POS))
#define SPI_1_INTR_I2C_EC_EZBUF_WRITE_STOP     ((uint32) ((uint32) 0x01u << \
...
#define SPI_1_INTR_MASTER_I2C_NACK           ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_INTR_MASTER_I2C_NACK_POS))
#define SPI_1_INTR_MASTER_I2C_ACK            ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_INTR_MASTER_I2C_ACK_POS))
#define SPI_1_INTR_MASTER_I2C_STOP           ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_INTR_MASTER_I2C_STOP_POS))
#define SPI_1_INTR_MASTER_I2C_BUS_ERROR      ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_INTR_MASTER_I2C_BUS_ERROR_POS))
#define SPI_1_INTR_MASTER_SPI_DONE           ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_INTR_MASTER_SPI_DONE_POS))
...
#define SPI_1_INTR_SLAVE_I2C_NACK                 ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_INTR_SLAVE_I2C_NACK_POS))
#define SPI_1_INTR_SLAVE_I2C_ACK                  ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_INTR_SLAVE_I2C_ACK_POS))
#define SPI_1_INTR_SLAVE_I2C_WRITE_STOP           ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_INTR_SLAVE_I2C_WRITE_STOP_POS))
#define SPI_1_INTR_SLAVE_I2C_STOP                 ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_INTR_SLAVE_I2C_STOP_POS))
#define SPI_1_INTR_SLAVE_I2C_START                ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_INTR_SLAVE_I2C_START_POS))
#define SPI_1_INTR_SLAVE_I2C_ADDR_MATCH           ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_INTR_SLAVE_I2C_ADDR_MATCH_POS))
#define SPI_1_INTR_SLAVE_I2C_GENERAL              ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_INTR_SLAVE_I2C_GENERAL_POS))
#define SPI_1_INTR_SLAVE_I2C_BUS_ERROR            ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_INTR_SLAVE_I2C_BUS_ERROR_POS))
#define SPI_1_INTR_SLAVE_SPI_EZBUF_WRITE_STOP     ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_INTR_SLAVE_SPI_EZBUF_WRITE_STOP_POS))
#define SPI_1_INTR_SLAVE_SPI_EZBUF_STOP           ((uint32) ((uint32) 0x01u << \
                                                                    SPI_1_INTR_SLAVE_SPI_EZBUF_STOP_POS))
#define SPI_1_INTR_SLAVE_SPI_BUS_ERROR           ((uint32) ((uint32) 0x01u << \
...
#define SPI_1_INTR_TX_NOT_FULL           ((uint32) ((uint32) 0x01u << \
                                                                        SPI_1_INTR_TX_NOT_FULL_POS))
#define SPI_1_INTR_TX_EMPTY              ((uint32) ((uint32) 0x01u << \
                                                                        SPI_1_INTR_TX_EMPTY_POS))
#define SPI_1_INTR_TX_OVERFLOW           ((uint32) ((uint32) 0x01u << \
                                                                        SPI_1_INTR_TX_OVERFLOW_POS))
#define SPI_1_INTR_TX_UNDERFLOW          ((uint32) ((uint32) 0x01u << \
                                                                        SPI_1_INTR_TX_UNDERFLOW_POS))
#define SPI_1_INTR_TX_BLOCKED            ((uint32) ((uint32) 0x01u << \
                                                                        SPI_1_INTR_TX_BLOCKED_POS))
#define SPI_1_INTR_TX_UART_NACK          ((uint32) ((uint32) 0x01u << \
                                                                        SPI_1_INTR_TX_UART_NACK_POS))
#define SPI_1_INTR_TX_UART_DONE          ((uint32) ((uint32) 0x01u << \
                                                                        SPI_1_INTR_TX_UART_DONE_POS))
#define SPI_1_INTR_TX_UART_ARB_LOST      ((uint32) ((uint32) 0x01u << \
                                                                        SPI_1_INTR_TX_UART_ARB_LOST_POS))
...
#define SPI_1_INTR_RX_NOT_EMPTY          ((uint32) ((uint32) 0x01u << \
                                                                        SPI_1_INTR_RX_NOT_EMPTY_POS))
#define SPI_1_INTR_RX_FULL               ((uint32) ((uint32) 0x01u << \
                                                                        SPI_1_INTR_RX_FULL_POS))
#define SPI_1_INTR_RX_OVERFLOW           ((uint32) ((uint32) 0x01u << \
                                                                        SPI_1_INTR_RX_OVERFLOW_POS))
#define SPI_1_INTR_RX_UNDERFLOW          ((uint32) ((uint32) 0x01u << \
                                                                        SPI_1_INTR_RX_UNDERFLOW_POS))
#define SPI_1_INTR_RX_BLOCKED            ((uint32) ((uint32) 0x01u << \
                                                                        SPI_1_INTR_RX_BLOCKED_POS))
#define SPI_1_INTR_RX_FRAME_ERROR        ((uint32) ((uint32) 0x01u << \
                                                                        SPI_1_INTR_RX_FRAME_ERROR_POS))
#define SPI_1_INTR_RX_PARITY_ERROR       ((uint32) ((uint32) 0x01u << \
                                                                        SPI_1_INTR_RX_PARITY_ERROR_POS))
#define SPI_1_INTR_RX_BAUD_DETECT        ((uint32) ((uint32) 0x01u << \
                                                                        SPI_1_INTR_RX_BAUD_DETECT_POS))
#define SPI_1_INTR_RX_BREAK_DETECT       ((uint32) ((uint32) 0x01u << \
                                                                        SPI_1_INTR_RX_BREAK_DETECT_POS))
...
/* Writes interrupt source: set sourceMask bits in SPI_1_INTR_X_MASK_REG */
...
/* Enables interrupt source: set sourceMask bits in SPI_1_INTR_X_MASK_REG */
...
/* Disables interrupt source: clear sourceMask bits in SPI_1_INTR_X_MASK_REG */
...
/* Sets interrupt sources: write sourceMask bits in SPI_1_INTR_X_SET_REG */
...
/* Clears interrupt sources: write sourceMask bits in SPI_1_INTR_X_REG */
...
#define SPI_1_CHECK_INTR_EC_I2C(sourceMask)  (0u != (SPI_1_INTR_I2C_EC_REG & (sourceMask)))
#define SPI_1_CHECK_INTR_EC_SPI(sourceMask)  (0u != (SPI_1_INTR_SPI_EC_REG & (sourceMask)))
...
/* Returns true if bit is set in SPI_1_I2C_STATUS_REG */
#define SPI_1_CHECK_I2C_STATUS(sourceMask)   (0u != (SPI_1_I2C_STATUS_REG & (sourceMask)))

/* Returns true if bit is set in SPI_1_SPI_STATUS_REG */
