...
#if !defined(W5100_1_H)
#define W5100_1_H

#define W5100_1_READ_OP         ( 0x0F )
#define W5100_1_WRITE_OP        ( 0xF0 )

#define W5100_1_IPADDRESS(x1,x2,x3,x4)   ( (uint32)(x1&0x000000FF) + (uint32)((x2<<8)&0x0000FF00) + (uint32)((x3<<16)&0x00FF0000) + ((uint32)(x4<<24)&0xFF000000 ))

#define W5100_1_PROTO_TCP        ( 1 )
#define W5100_1_PROTO_UDP        ( 2 )
#define W5100_1_PROTO_IP         ( 3 )
#define W5100_1_PROTO_MAC        ( 4 )
 ...
 *
 * \note this function is usuallt called from W5100_1_Start()
 * \sa W5100_1_Start()
 */
void W5100_1_Init(uint8* mac, uint32 ip, uint32 subnet, uint32 gateway);
 ...
 */
uint32 W5100_1_ParseIP( const char* ipString );
 ...
 * be returned.
 * \sa W5100_1_PROTO_TCP
 * \sa W5100_1_PROTO_UDP
 * \sa W5100_1_PROTO_IP
 * \sa W5100_1_PROTO_MAC
 */
uint8 W5100_1_SocketOpen( uint8 Protocol, uint16 port, uint8 flags );
 ...
 * has no effect.
 */
void W5100_1_SocketClose( uint8 socket );
 ...
 */
uint8 W5100_1_SocketProcessConnections( uint8 socket );
 ...
 */
uint8 W5100_1_SocketEstablished( uint8 socket );
 ...
 */
uint16 W5100_1_SocketRxDataWaiting( uint8 socket );
 ...
 * \sa W5100_1_SocketOpen()
 * \sa W5100_1_SocketClose()
 */
uint8 W5100_1_TcpOpen(uint16 port);
 ...
 * \sa W5100_1_SocketClose()
 */
void W5100_1_TcpStartServer( uint8 socket );
 ...
 * \sa W5100_1_TcpStartServer()
 * \sa W5100_1_TcpOPen();
 * \sa W5100_1_SocketClose()
 */
void W5100_1_TcpStartServerWait( uint8 socket );
 ...
 * \sa W5100_1_TcpOpen()
 * \sa W5100_1_TcpStartServer()
 * \sa W5100_1_TcpStartServerWait()
 * \sa W5100_1_TcpConnected()
 * \sa W5100_1_TcpDisconnect()
 */
void W5100_1_TcpConnect( uint8 socket, uint32 ip, uint16 port );
 ...
 * \sa W5100_1_TcpConnect()
 * \sa W5100_1_TcpStartServer()
 */
uint8 W5100_1_TcpConnected( uint8 socket );
 ...
 * \sa W5100_1_TcpStartServerWait()
 */
void W5100_1_TcpDisconnect( uint8 socket );
 ...
 * \sa W5100_1_TcpStartServerWait()
 * \sa W5100_1_TcpPrint()
 * \sa W5100_1_TcpReceive()
 */
uint16 W5100_1_TcpSend(uint8 socket, uint8* buffer, uint16 len);
 ...
 * \sa W5100_1_TcpSend()
 */
uint16 W5100_1_TcpReceive( uint8 socket, uint8* buffer, uint16 length );
 ...
 *
 * this function is a shortcut to using the W5100_1_TcpSend()
 ...
 * \sa W5100_1_TcpReceive()
 */
void W5100_1_TcpPrint( uint8 socket, const char* str );
 ...
 * \sa W5100_1_SocketClose()
 */
uint8 W5100_1_UdpOpen(uint16 port);
 ...
 * \sa W5100_1_UdpReceive()
 */
uint16 W5100_1_UdpSend(uint8 socket, uint32 ip, uint16 port, uint8* buffer, uint16 length);
 ...
 * \sa W5100_1_UdpSend()
 */
uint16 W5100_1_UdpReceive(uint8 socket, uint32 *ip, uint16 *port, uint8* buffer, uint16 length);
