...
***************************************/
    ...
    *  Call SPI_1_SpiUartGetRxBufferSize() to return buffer size.
    ...
    *
    *******************************************************************************/
    void SPI_1_SpiUartWriteTxData(uint32 txDataByte)
    {
        #if(SPI_1_INTERNAL_TX_SW_BUFFER_CONST)
            uint32 locHead;
            uint32 intSourceMask;
        ...
        #if(SPI_1_CHECK_TX_SW_BUFFER)
        {
               ...
               (SPI_1_FIFO_SIZE != SPI_1_GET_TX_FIFO_ENTRIES))
            {
                ...
                SPI_1_TX_FIFO_WR_REG = txDataByte;
            }
            ...
            else
            {
                ...
                SPI_1_PutWordInTxBuffer(locHead, txDataByte);
